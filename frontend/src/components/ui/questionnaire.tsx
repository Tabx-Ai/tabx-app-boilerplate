...
/*
 * Vendored from shadcn's registry (spec 082 FR-001), adapted only as far as every vendored
 * primitive is: `cn` from `@/lib/utils`, the button from `ui/button`, and the registry's
 * multi-pack IconPlaceholder replaced by the lucide check this app already uses. Behaviour is
 * @shadcn/react's, untouched — answers leave as FormData through onSubmit (FR-003), which is
 * the named Article IX §3 exception recorded in the spec's plan.md.
 */
    ...
    >
      ...
      >
        ...
        <Check
          ...
          className="cn-questionnaire-choice-indicator-check hidden size-3.5 group-data-[type=radio]/questionnaire-choice:hidden group-data-checked/questionnaire-choice:block"
        />
      </span>
